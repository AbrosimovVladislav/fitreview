...
const RootLayout = () => {
    ...
    if (isLoading) {
        // Показываем индикатор загрузки, пока проверяется статус пользователя
        return (
    ...
    if (isLoggedIn) {
        // Если пользователь залогинен, перенаправляем на домашний экран
        return <Redirect href="/home" />;
    }

    // Если пользователь не залогинен, показываем приветственный экран
    return (
